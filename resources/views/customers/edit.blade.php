        ...
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <form action="{{ route('customers.update', $customer) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="telp" value="{{ old('telp', $customer->telp) }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-3">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="alamat" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-3">{{ old('alamat', $customer->alamat) }}</textarea>
